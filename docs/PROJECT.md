# PROJECT — NORIZO DEV ROOM

## Mission

Build a durable AI development team in which NORIZO, ChatGPT, Claude Code and Gemini can work on the same projects without NORIZO acting as a message relay.

The team is established first on GitHub. ConoHa is attached later as the 24/7 execution workplace for the same team and rules.
...
- GitHub — shared office, audit trail and canonical repository

## Success criteria

1. All agents can recover context from GitHub without copied chat transcripts.
